...
API_ID = 29184927
API_HASH = "5668f1df08d74abec036fcdfaefa4009"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="7085600946").split()))
for x in FRIDAY:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="7085600946"))
